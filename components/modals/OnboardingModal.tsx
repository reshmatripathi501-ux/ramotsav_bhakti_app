...
import { HomeIcon, GranthIcon, DarshanIcon, JaapIcon, UploadIcon } from '../icons';
...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onClose }) => {
    return (
        <div className="fixed inset-0 bg-black/90 z-[101] flex items-center justify-center p-4">
            <div 
                className="bg-[#1e0f05] border-2 border-amber-600 rounded-2xl w-full max-w-md max-h-[90vh] flex flex-col shadow-2xl shadow-amber-900/50 animate-zoom-in"
            >
                <div className="p-4 border-b border-amber-800 text-center">
                    <h2 className="text-xl font-cinzel text-amber-300">Welcome to Ramotsav!</h2>
                    <p className="text-gray-400 text-sm">Your daily portal for devotion.</p>
                </div>
